...
- Desktop app-shell desktop page chrome no longer renders the shared framed header card or status pills; pages now show only a plain shared headline above their content.
