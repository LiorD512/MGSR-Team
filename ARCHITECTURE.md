...
- Desktop app-shell brand block now removes the eyebrow microcopy near the sidebar logo and renders a single stronger gold BRIT Sport Group wordmark vertically centered with the logo.
- Desktop app-shell page chrome now shows only the main page headline across shared pages; the extra eyebrow microcopy and descriptive subtitle were removed globally from the shared desktop header.
