...
import com.liordahan.mgsrteam.features.scouting.ScoutApiClient
...
val playersModule = module {
    ...
    single { AiHelperService(get<PlayerSearch>(), get<ClubSquadValueFetcher>(), get<LatestReleases>(), get<ScoutApiClient>()) }
    single {
