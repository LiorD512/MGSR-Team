...
/**
 * Women-dedicated feed event data class.
 * Maps to the "FeedEventsWomen" Firestore collection.
 */
@Keep
data class WomenFeedEvent(
    @DocumentId
    val id: String? = null,
...
fun WomenFeedEvent.toSharedFeedEvent(): com.liordahan.mgsrteam.features.home.models.FeedEvent {
