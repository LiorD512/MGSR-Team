...
/**
 * Youth-dedicated agent task data class.
 * Maps to the "AgentTasksYouth" Firestore collection.
 */
@Keep
data class YouthAgentTask(
    @DocumentId
    val id: String = "",
    val agentId: String = "",
...
fun YouthAgentTask.toSharedAgentTask(): com.liordahan.mgsrteam.features.home.models.AgentTask {
