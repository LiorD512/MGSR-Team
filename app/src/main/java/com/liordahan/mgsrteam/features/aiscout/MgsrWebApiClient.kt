        ...
        for (i in 0 until arr.length()) {
            ...
            candidates.add(
                DiscoveryCandidate(
                    ...
                    goalsPerNinety = c.optDoubleOrNull("apiGoalsPer90") ?: c.optDoubleOrNull("fbrefGoalsPer90") ?: c.optDoubleOrNull("goalsPerNinety") ?: c.optDoubleOrNull("gPer90"),
                    assistsPerNinety = c.optDoubleOrNull("apiAssistsPer90") ?: c.optDoubleOrNull("fbrefAssistsPer90") ?: c.optDoubleOrNull("assistsPerNinety") ?: c.optDoubleOrNull("aPer90"),
                    apiRating = c.optDoubleOrNull("apiRating"),
