...
export async function generateMandatePdf(data: MandateData): Promise<Uint8Array> {
  ...
  if (data.originAgentName && data.originAgentId) {
    ...
    drawText(
      `This mandate is valid through the player agent. Name: ${data.originAgentName}, ${idLabel}: ${data.originAgentId}.`,
      BODY_SIZE,
      false
    );
    y -= 4;
  ...
  const sections = [
    ...
    ['SERVICE FEE', '6. In consideration of the exclusive Mandate, If the club does not pay any commission, the player will pay the agent 5% of his salary on a monthly basis (excluding bonuses and other non-base salary).'],
    ['', 'In case the club will pay the commission \u2013 the commission will be paid the agent (if there more than one agent involved from other agencies, the commission will be paid equally 50-50% (form the commission paid by the club).'],
    ...
    ['', '9. dual representation being allowed by the applicable regulatory framework, without prejudice to any transaction-specific disclosures and consents required at the relevant time. Dual representation will be allowed Only by written consent by the player.'],
    ...
    ['CUMULATIVE PENALTY', '12. If the Player breaches this Mandate, including by violating exclusivity, using a third party to perform football agent services, or revoking or terminating the Mandate without just cause according to FIFA rules, the Player shall pay a contractual penalty equal to 20% of the player monthly salary (one month penalty). The penalty is cumulative and payable in addition to the service fee.'],
    ...
    ['', '16. The Parties agree to maintain strict confidentiality regarding all financial terms, player data, and negotiation strategies disclosed during this mandate. This information shall not be shared with any third party, including media or unauthorized club officials, without prior written consent unless required by law or FIFA regulations. This obligation remains in full effect throughout the duration of the agreement. For Authorized club officials the player give his consent to give the relevant information.'],
    ['TERMINATION', '17. Either Party may terminate this Mandate for just cause by written notice to the other Party. By email or WhatsApp to the agent in the mandate.'],
    ['', '18. Just cause exists where, in accordance with good faith, a Party cannot reasonably be expected to continue the contractual relationship, including where the other Party commits a material breach and fails to remedy it within fourteen (14) days of receipt of written notice specifying the breach, if such breach is capable of remedy.'],
    ['', '19. Termination shall not affect rights or obligations accrued prior to termination, nor provisions intended to survive termination, including service fees already earned, survival of remuneration rights, exclusivity consequences, confidentiality, and dispute resolution.'],
    ['GOVERNING LAW AND ARBITRATION', '20. This Mandate is governed by Swiss law.'],
    ['', '21. Any dispute arising out of or in connection with this Mandate shall be submitted exclusively to the Court of Arbitration for Sport (CAS), Lausanne, before a sole arbitrator, in English, under an expedited procedure with CAS deadlines. CAS shall notify the operative part of the award prior to the reasons.'],
    ['', '22. The Football Agent and the Agency each have standing to sue and enforce this arbitration agreement and any award.'],
    ['INDEPENDENT LEGAL ADVICE', '23. The Player confirms that the Football Agent informed him in writing that he should consider obtaining independent legal advice and that the Player has either obtained such advice or knowingly waived it.'],
