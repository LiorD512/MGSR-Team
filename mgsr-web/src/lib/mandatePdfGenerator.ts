...
export async function generateMandatePdf(data: MandateData): Promise<Uint8Array> {
  ...
  const sections = [
    ...
    ['EXCLUSIVITY', '3. The Mandate is exclusive. During the Term, the Player shall not appoint, consult, or use any third party, whether licensed or unlicensed, to perform football agent services or to negotiate or facilitate a transaction on the Player\'s behalf.'],
