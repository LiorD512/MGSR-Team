  ...
  return (
    <AppLayout>
      <div className="max-w-6xl mx-auto">
        {/* Hero header */}
        <div className={`brit-hero-panel relative overflow-hidden rounded-2xl sm:rounded-3xl mb-6 sm:mb-10 ${isYouth ? 'shadow-[0_0_40px_rgba(0,212,255,0.12)]' : isWomen ? 'shadow-[0_0_40px_rgba(232,160,191,0.12)]' : ''}`}>
