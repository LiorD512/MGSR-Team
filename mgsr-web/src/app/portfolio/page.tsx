...
export default function PortfolioPage() {
  ...
  const [showShareLangModal, setShowShareLangModal] = useState<string | null>(null);
  ...
  const handleShare = useCallback(
    async (item: PortfolioItem, lang: 'he' | 'en') => {
        ...
        {loadingItems ? (
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {items.map((item) => {
              ...
              const showLangForThis = showShareLangModal === item.id;
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="mt-5 flex items-center gap-2">
                      <button
                        type="button"
                        onClick={() => setShowShareLangModal(item.id)}
                        disabled={isSharing}
                  ...
                  {/* Share language modal for this card */}
                  {showLangForThis && (
                    <div
                      className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4"
                      onClick={() => setShowShareLangModal(null)}
                    >
                      ...
                      >
                        ...
                        <p className="text-sm text-mgsr-muted mb-4">
                          {isRtl
                            ? 'בחר את שפת הדף המשותף'
                            : 'Choose the language for the shared page'}
                        </p>
                        <div className="flex gap-3">
                          <button
                            type="button"
                            onClick={() => handleShare(item, 'he')}
                            disabled={isSharing}
