...
export default function FindNextPage() {
  ...
  // Warm the scout server on mount
  useEffect(() => {
  ...
  const examples = lang === 'he' ? EXAMPLE_PLAYERS_HE : EXAMPLE_PLAYERS_EN;
  const isHe = lang === 'he';
