            ...
            <div className="mt-2 space-y-2">
              {isLoadingTeammates ? (
                ...
                rosterTeammates?.map((match) => (
                  <div key={match.player.id} className="flex items-center gap-3 p-2.5 rounded-xl bg-mgsr-dark/50 border border-mgsr-border/80 hover:border-purple-500/40 hover:bg-mgsr-dark/70 transition-all">
                    <Link
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      ...
                      <span className="text-xs font-medium text-purple-400 px-2 py-0.5 rounded-md bg-purple-500/15">
