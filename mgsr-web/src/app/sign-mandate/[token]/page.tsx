      ...
      <div className="max-w-2xl mx-auto py-6 sm:py-10 px-4">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="font-display font-bold text-mgsr-teal tracking-tight text-sm">BRIT<span className="text-mgsr-muted font-normal ml-1">Sport Group</span></span>
          </div>
